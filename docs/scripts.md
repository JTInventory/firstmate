...
| `fm-wake-lib.sh`         | Shared durable wake queue and portable lock helpers, including dead-pid and mismatched-identity stale lock recovery, sourced by the watcher, drain, arm, guard, and daemon |
