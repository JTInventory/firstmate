...
tests/fm-backend-herdr-presentation-e2e.test.sh # focused Herdr launch/teardown proof; requires jq and an installed Herdr protocol >=16, and preflights the host without mutating its default session
